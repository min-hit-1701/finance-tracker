...
public interface BudgetDao {
    ...
    List<Budget> getBudgetsByPeriodSync(String period);

    @Query("UPDATE budgets SET name = :name, limitAmount = :limit, spentAmount = :used, period = :period WHERE id = :id")
    void updateBudget(int id, String name, double limit, double used, String period);
}
